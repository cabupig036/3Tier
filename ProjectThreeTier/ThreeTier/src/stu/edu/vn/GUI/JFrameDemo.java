...
public class JFrameDemo extends javax.swing.JFrame {
    ...
    // when add reload the local source in UI
    //when add call the bussiness add the new note to DB
    
    DefaultTableModel listNotesModel = null;
    Note currentNote = null; // use when to interact with update delete
    Business business = new Business();
    ArrayList<Note> NotesCollection = new ArrayList<>();


    public JFrameDemo() {
        initComponents();
        this.setLocationRelativeTo(null);
        listNotesModel = (DefaultTableModel) tblListNote.getModel();
        NotesCollection = business.getAllNotes();
    }
    ...
    private void initComponents() {
        ...
        tblListNote.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tblListNoteMouseReleased(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGap(94, 94, 94)
                            .addComponent(btnDeleteAll, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        //bussiness ok wait add DB
        Note tempNote = new Note(txtTitle.getText(), txaContent.getText());
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(listNotesModel.getRowCount() == 0){
        ...
        int selectedRow = tblListNote.getSelectedRow();
        business.Delete(selectedRow);
        refresh();
        bindingToTableView();
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        currentNote.setContent(txaContent.getText());
        bindingToTableView();
        refresh();
        }
    ...
    private void btnDeleteAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteAllActionPerformed
        listNotesModel.setRowCount(0);
        business.DeleteAll();
        refresh();
    }//GEN-LAST:event_btnDeleteAllActionPerformed

    private void tblListNoteMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblListNoteMouseReleased
        // TODO add your handling code here:
        currentNote = NotesCollection.get(tblListNote.getSelectedRow());
        txtTitle.setText(currentNote.getTitle());
        txaContent.setText(currentNote.getContent());
    }//GEN-LAST:event_tblListNoteMouseReleased
    public void bindingToTableView() {
        //work well - Truong check
        listNotesModel.setRowCount(0);
        for (int index = 0; index < NotesCollection.size(); index++) {
            Note temp = NotesCollection.get(index);
            listNotesModel.addRow(new Object[]{temp.getTitle(), temp.getContent()});
        }
    }
